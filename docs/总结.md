...
![mrcpluginwithfreeswitch](F:\毕业设计\mrcpluginwithfreeswitch.png)
...
6. 运行与测试
   ...
   ![zoiper](F:\毕业设计\photos\zoiper.png)

   然后点击Next Skip等等就可以了，等待一会儿后就可以登录了，如图所示：

   ![zoiper2](F:\毕业设计\photos\zoiper2.png)
...
7. 重新编译安装UniMRCP
   ...
   ​	![unimrcp](F:\毕业设计\photos\unimrcp.png)
...
function onInputCBF(s, type,obj)
...
freeswitch.consoleLog("CRIT","Finally Result is '" .. xml .. "'\n")
freeswitch.consoleLog("CRIT","Finally Result is '" .. xml .. "'\n")
freeswitch.consoleLog("CRIT","Finally Result is '" .. xml .. "'\n")
freeswitch.consoleLog("NOTICE","silence\n")
session:streamFile("silence_stream://-1,1400") 
